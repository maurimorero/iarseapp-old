from models import Dimension, Encuesta, Question, Category, Survey, Response, ResponseMgr, AnswerText, AnswerRadio, AnswerSelect, AnswerInteger, AnswerSelectMultiple
...
class ResponseAdmin(admin.ModelAdmin):
	list_display = ('interview_uuid', 'created','user_id')
...
admin.site.register(ResponseMgr)
